...
import LoginLogo from '../assets/logo-cat.jpg'
...
function Login() {
  ...
  return (
    <Box sx={{
      ...
      background: 'url("src/assets/bg-Login.JPG")',
          ...
          <MuiCard sx={{ minWidth: 480, maxWidth: 480, marginTop: '6em', p: '2em 1em', borderRadius: 2 }}>
            <Box sx={{ width: '70px', bgcolor: 'white', margin: '0 auto' }}>
              <a style={{ color: 'inherit', textDecoration: 'none' }} href='https://github.com/tuanvdtd' target='_blank' rel='noreferrer'>
                <img src={LoginLogo} alt='dev' width='100%' style={{ borderRadius: '50%' }} />
              </a>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'center', color: theme => theme.palette.grey[500] }}>
              <Box>
                <Typography>Hint: dev@gmail.com</Typography>
                <Typography>Pass: dev@123</Typography>
              </Box>
            </Box>
